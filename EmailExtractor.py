...
class Extractor(WhmcScrapper):
    ...
    UNREAD_PARAMS = {'removeLabelIds': ['UNREAD','Label_5731120152959481311'],
            'addLabelIds': ['INBOX']
                     }
    ...
    def get_all_email(self,service):
        ...
        cash_app_emails = service.users().messages().list(userId="me", q="from:cash@square.com",maxResults=1000000,
        ...
        google_pay_emails = service.users().messages().list(userId="me", q="from:googlepay-noreply@google.com",
        ...
        zelle_emails = service.users().messages().list(userId="me", q="from:customerservice@ealerts.bankofamerica.com",
                                                            maxResults=1000000, labelIds=['UNREAD']).execute()
